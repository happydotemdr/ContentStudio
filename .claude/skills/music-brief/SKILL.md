...
sitting alongside `voiceover-brief` and `visual-prompts` as one of the parallel stages that follow
`shorts-scripting`. It is deliberately thin: it owns the bed's arc and nothing else.
