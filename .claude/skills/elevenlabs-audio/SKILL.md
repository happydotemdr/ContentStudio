...
**Pipeline (ContentStudio Shorts).** `voiceover-brief` (skill #3 of the six-skill pipeline) hands
down the corpus-grounded **creative** call: voice character, tone per beat, content type, and the
